        ...
        private void btnValiderManquant_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                using (var ct = new DocumatContext())
                {
                    ...
                    {
                        IdRegistre = ImageController.RegistreParent.RegistreID,
                        IdImage = null,
                        NumeroPage = numPage,
